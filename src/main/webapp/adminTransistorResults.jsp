    ...
    <table id="transistorTable" class="display" cellspacing="0" width="100%">
        ...
        <c:forEach var="part" items="${transistors}">
            ...
            <tr>
                ...
                <td>${part.cost}</td>
                <td><a href="adminTransistorDetails.jsp?partNum=${part.partNum}&partTech=${part.technology}&partDesc=${part.descr}&partQty=${part.qty}&partPkg=${part.packageName}&partCost=${part.cost}"><button type="button" class="btn btn-primary">Edit Details</button></a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
