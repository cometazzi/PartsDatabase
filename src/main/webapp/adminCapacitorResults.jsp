    ...
    <table id="capacitorTable" class="display" cellspacing="0" width="100%">
        ...
        <c:forEach var="part" items="${capacitors}">
            ...
            <tr>
                ...
                <td>${part.qty}</td>
                <td>${part.cost}</td>
                <td><a href="adminCapacitorDetails.jsp?partNum=${part.partNum}&partDesc=${part.descr}&partQty=${part.qty}&partCost=${part.cost}"><button type="button" class="btn btn-primary">Edit Details</button></a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
