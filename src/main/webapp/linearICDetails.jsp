...
<div class="container-fluid">
    ...
    <dl class="row">
        ...
        <dd class="col-sm-9">${linearIC.partNum}</dd>
        
        <dt class="col-sm-3">Description:</dt>
        <dd class="col-sm-9">${linearIC.descr}</dd>

        <dt class="col-sm-3">Quantity:</dt>
        <dd class="col-sm-9">${linearIC.qty}</dd>

        <dt class="col-sm-3">Package Type:</dt>
        <dd class="col-sm-9">${linearIC.packageName}</dd>

        <dt class="col-sm-3">Cost:</dt>
        <dd class="col-sm-9">${linearIC.cost}</dd>
    ...
    <br>
    <p><a href="linearICSearch.jsp">Back to Linear IC Search</a></p>
