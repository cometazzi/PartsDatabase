...
<div class="container-fluid">
    ...
    <dl class="row">
        ...
        <dd class="col-sm-9">${diode.partNum}</dd>

        <dt class="col-sm-3">Description:</dt>
        <dd class="col-sm-9">${diode.descr}</dd>

        <dt class="col-sm-3">Quantity:</dt>
        <dd class="col-sm-9">${diode.qty}</dd>

        <dt class="col-sm-3">Package Type:</dt>
        <dd class="col-sm-9">${diode.packageName}</dd>

        <dt class="col-sm-3">Cost:</dt>
        <dd class="col-sm-9">${diode.cost}</dd>
    ...
    <br>
    <p><a href="diodeSearch.jsp">Back to Diode Search</a></p>
