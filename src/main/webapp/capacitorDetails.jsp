...
<div class="container-fluid">
    ...
    <dl class="row">
        ...
        <dd class="col-sm-9">${capacitor.partNum}</dd>

        <dt class="col-sm-3">Description:</dt>
        <dd class="col-sm-9">${capacitor.descr}</dd>

        <dt class="col-sm-3">Quantity:</dt>
        <dd class="col-sm-9">${capacitor.qty}</dd>

        <dt class="col-sm-3">Cost:</dt>
        <dd class="col-sm-9">${capacitor.cost}</dd>
    ...
    <br>
    <p><a href="capacitorSearch.jsp">Back to Capacitor Search</a></p>
