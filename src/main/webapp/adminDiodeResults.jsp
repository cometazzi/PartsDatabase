    ...
    <table id="diodeTable" class="display" cellspacing="0" width="100%">
        ...
        <c:forEach var="part" items="${diodes}">
            ...
            <tr>
                ...
                <td>${part.cost}</td>
                <td><a href="adminDiodeDetails.jsp?partNum=${part.partNum}&partDesc=${part.descr}&partQty=${part.qty}&partPkg=${part.packageName}&partCost=${part.cost}"><button type="button" class="btn btn-primary">Edit Details</button></a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
